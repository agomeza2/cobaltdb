...
obtenerDatos().then(graph => {
  ...
  const simulation = d3.forceSimulation(nodes)
    .force("link", d3.forceLink(links).id(d => d.name).distance(100)) // Usamos "name" como ID
    .force("charge", d3.forceManyBody().strength(-400))  // Fuerza negativa para dispersar nodos
